package in.taxi.smartdriver.net;
...
import in.taxi.smartdriver.listeners.AccessibilityListener;
import in.taxi.smartdriver.listeners.AppStatusListener;
import in.taxi.smartdriver.listeners.BasicListener;
import in.taxi.smartdriver.listeners.CommentListListener;
import in.taxi.smartdriver.listeners.DocumentStatusListener;
import in.taxi.smartdriver.listeners.HelpListListener;
import in.taxi.smartdriver.listeners.HelpListener;
import in.taxi.smartdriver.listeners.IssueListListener;
import in.taxi.smartdriver.listeners.LoginListener;
import in.taxi.smartdriver.listeners.PhoneRegistrationListener;
import in.taxi.smartdriver.listeners.PolyPointListener;
import in.taxi.smartdriver.listeners.ProfileListener;
import in.taxi.smartdriver.listeners.RatingDetailsListener;
import in.taxi.smartdriver.listeners.RegistrationListener;
import in.taxi.smartdriver.listeners.RequestDetailsListener;
import in.taxi.smartdriver.listeners.TripDetailsListener;
import in.taxi.smartdriver.listeners.TripFeedbackListener;
import in.taxi.smartdriver.listeners.TripListListener;
import in.taxi.smartdriver.listeners.TripSummaryListener;
import in.taxi.smartdriver.listeners.WeeklyEarningsListener;
...
import in.taxi.smartdriver.net.WSAsyncTasks.AccessibilityTask;
import in.taxi.smartdriver.net.WSAsyncTasks.AppStatusTask;
import in.taxi.smartdriver.net.WSAsyncTasks.ArrivalConfirmationTask;
import in.taxi.smartdriver.net.WSAsyncTasks.CashCollectionTask;
import in.taxi.smartdriver.net.WSAsyncTasks.CommentListTask;
import in.taxi.smartdriver.net.WSAsyncTasks.DocumentStatusTask;
import in.taxi.smartdriver.net.WSAsyncTasks.DocumentUploadTask;
import in.taxi.smartdriver.net.WSAsyncTasks.DriverAccessibilityTask;
import in.taxi.smartdriver.net.WSAsyncTasks.DriverStatusChangeTask;
import in.taxi.smartdriver.net.WSAsyncTasks.DriverStatusTask;
import in.taxi.smartdriver.net.WSAsyncTasks.DriverTypeRegistrationTask;
import in.taxi.smartdriver.net.WSAsyncTasks.ForgotPasswordTask;
import in.taxi.smartdriver.net.WSAsyncTasks.HelpListTask;
import in.taxi.smartdriver.net.WSAsyncTasks.HelpPageReviewTask;
import in.taxi.smartdriver.net.WSAsyncTasks.HelpTask;
import in.taxi.smartdriver.net.WSAsyncTasks.IssueListTask;
import in.taxi.smartdriver.net.WSAsyncTasks.LoginTask;
import in.taxi.smartdriver.net.WSAsyncTasks.MobileAvailabilityCheckTask;
import in.taxi.smartdriver.net.WSAsyncTasks.OTPResendCodeTask;
import in.taxi.smartdriver.net.WSAsyncTasks.OTPSubmitTask;
import in.taxi.smartdriver.net.WSAsyncTasks.PhoneRegistrationTask;
import in.taxi.smartdriver.net.WSAsyncTasks.PolyPointTask;
import in.taxi.smartdriver.net.WSAsyncTasks.ProfilePhotoUploadTask;
import in.taxi.smartdriver.net.WSAsyncTasks.ProfileTask;
import in.taxi.smartdriver.net.WSAsyncTasks.ProfileUpdateTask;
import in.taxi.smartdriver.net.WSAsyncTasks.RatingDetailsTask;
import in.taxi.smartdriver.net.WSAsyncTasks.RegistrationTask;
import in.taxi.smartdriver.net.WSAsyncTasks.RequestDetailsTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TodayTripListTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TripAcceptTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TripCompletionTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TripDetailsTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TripFeedbackTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TripHistoryTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TripStartTask;
import in.taxi.smartdriver.net.WSAsyncTasks.TripSummaryTask;
import in.taxi.smartdriver.net.WSAsyncTasks.UpdateDriverLocationTask;
import in.taxi.smartdriver.net.WSAsyncTasks.UpdateFCMTokenTask;
import in.taxi.smartdriver.net.WSAsyncTasks.WeeklyEarningsTask;
